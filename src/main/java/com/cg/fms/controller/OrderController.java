...
public class OrderController {
	...
	@PostMapping("{orderNumber}/{deliveryPlace}/{deliveryDate}/{quantity}/{customerId}/{schedulerId}")
	...
	@PutMapping("{orderNumber}/{customerId}/{schedulerId}")
	public String updateOrder(@PathVariable("orderNumber") String orderNumber, String deliveryPlace,
			String deliveryDate, String quantity,@PathVariable("customerId") String customerId,@PathVariable("schedulerId") String schedulerId) {
